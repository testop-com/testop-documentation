...
[2-3 paragraphs summarizing the most critical findings from each SWOT category and strategic implications]
...
║ • [Key opportunity 3]    ║ • [Key threat 3]         ║
╚══════════════════════════╩══════════════════════════╝
```
...
- **Security Assessment:** [Security review scope]

---

## 2. Strengths

> **What the system does well and advantages it provides**
...
- **Evidence:** [Metrics, user feedback, or technical facts]
- **Business Value:** [How this benefits the organization]
...
> **Internal factors that put the system at a disadvantage**
...
- **Evidence:** [Specific examples, metrics, or user complaints]
...
├── [W#] [Brief description] - Affects [N] users
└── [W#] [Brief description] - Affects [N] users
...
> **External factors that could be advantageous to the system**
...
- **Strategic Fit:** [How it aligns with business goals]
...
> **External factors that could cause problems or damage**
...
- **Current Exposure:** [How vulnerable the system is]
- **Warning Signs:** [Indicators to monitor]
- **Mitigation Strategy:** [How to prevent or minimize]
- **Contingency Plan:** [What to do if threat materializes]
- **Timeline:** [When this threat might occur]
...
```
HIGH PROBABILITY / HIGH IMPACT (Critical - Act Now):
├── [T#] [Brief description]
└── [T#] [Brief description]
...
| Aspect | Current System | Industry Standard | Gap |
|--------|----------------|-------------------|-----|
| Performance | [Rating] | [Rating] | [+/-] |
| Security | [Rating] | [Rating] | [+/-] |
| UX/Usability | [Rating] | [Rating] | [+/-] |
...
└── Focus: Address critical weaknesses and mitigate immediate threats
    ├── [Action item]
    ├── [Action item]
    └── [Action item]

Phase 2: Enhancement (Month 4-6)
└── Focus: Leverage strengths and pursue quick-win opportunities
    ├── [Action item]
    ├── [Action item]
    └── [Action item]

Phase 3: Transformation (Month 7-12)
└── Focus: Strategic improvements and innovation
    ├── [Action item]
    ├── [Action item]
    └── [Action item]
```
